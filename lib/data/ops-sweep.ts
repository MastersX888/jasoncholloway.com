...
export const tasks: SweepTask[] = [
  ...
  },
  {
    ...
    owner: 'JASON',
    effort: '15 min',
    detail: 'DEFERRED/SIDELINED — Apple ID create rejected: "Your account cannot be created at this time" for jason@seventhcitypress.com. Resume later: free Apple ID → ASC Books → search book IDs; keep author marketing ID 6769561663. No Developer Program; no tickets tonight. See APPLE_ID_SETUP_2026-08-03.md.',
  },
  {
    id: 'PUB-04',
    role: 'publishing',
  ...
  },
  {
    ...
    role: 'publishing',
    priority: 'P0',
    title: 'Ingram PB Vol I–III — approve live titles',
    status: 'done',
    owner: 'JASON',
    effort: '10 min',
    detail: 'CLOSED ~2026-08-03 afternoon CT — Jason: all IngramSpark titles approved and live. PB ISBNs 9798256008048 / 9798256009953 / 9798256010072 (omnibus PB 9798256072704). See scratch/ops_reports/INGRAM_ALL_TITLES_LIVE_2026-08-03.md.',
  },
  {
    id: 'PUB-10',
    role: 'publishing',
    priority: 'P0',
    title: 'Ingram HC Vol I–III — Revise Files live',
    status: 'done',
    owner: 'JASON',
    effort: '30 min',
    detail: 'CLOSED ~2026-08-03 afternoon CT — Jason: all IngramSpark titles approved and live. HC ISBNs 9798295800801 / 9798295812675 / 9798295812705 (omnibus HC 9798295884412).',
  },
  {
    id: 'PUB-11',
    role: 'publishing',
    priority: 'P1',
    title: 'Verify Ingram returnability + 55% wholesale (screenshots)',
    status: 'open',
    owner: 'JASON',
    effort: '10 min',
    detail: 'Title → Distribution / Pricing — screenshot returnable + wholesale % in portal. Do not assert in press until proven. Agent does not change portal settings.',
    dueContext: 'Trade-terms gate; still unverified after print LIVE.',
  },
  ...
  // ── MARKETING ───────────────────────────────────────────────────
  {
    ...
    role: 'marketing',
    priority: 'P1',
    title: 'Facebook Author Page — set custom username',
    status: 'open',
    owner: 'JASON',
    effort: '5 min',
    detail: 'Page is live at numeric ID. Set username "jasonhollowaykc" (or available variant) in Page Settings → General → Username. This gives a clean facebook.com/jasonhollowaykc URL that can replace the numeric one in socialProfiles.ts.',
    dueContext: 'Needed to update the URL in the website social files (currently showing numeric ID).',
  },
  {
    id: 'MKT-01',
    role: 'marketing',
  ...
  },
  {
    ...
    owner: 'JASON',
    effort: '10 min',
    detail: 'Author 20924993 claimed; About bio LIVE but missing StoryGraph cross-link. Remaining: paste updated About + verify website=jasoncholloway.com + genre + 3 public shelves. Run: scratch/ops_reports/GOODREADS_STORYGRAPH_LINK_2026-08-01.md',
  },
  {
    id: 'MKT-03',
    role: 'marketing',
    ...
    owner: 'JASON',
    effort: '15 min',
    detail: 'Vol I EPUB live 2026-08-01 (b9be8008…). Remaining: public profile jason_carroll_holloway + Goodreads link in bio + Vol II/III by ISBN. Browser MCP blocked in subagent. Run: scratch/ops_reports/GOODREADS_STORYGRAPH_LINK_2026-08-01.md',
  },
  {
    id: 'MKT-04',
    role: 'marketing',
  ...
  // ── AUTHORITY & DISCOVERY ──────────────────────────────────────
  {
    ...
    owner: 'JASON',
    effort: '10 min',
    detail: 'Claim 4 VERIFIED COMPLETE 2026-08-03 ~03:54 CT — Domain sc-domain:seventhcitypress.com verified (Jason Holloway zh5779485@gmail.com). Sitemap https://seventhcitypress.com/sitemap.xml Success (submitted Jul 22, last read Jul 31). Residual discovered pages=3 = post-claim hygiene only. Packet CLOSED.',
    dueContext: 'CLOSED · week bar 3/3 with Claim 1 + Claim 3.',
  },
  {
    id: 'AUTH-02',
    role: 'authority',
    ...
    dueContext: 'Wikidata P856 + GBP (Claim 5 DONE) together can reinforce Knowledge Panel.',
  },
  {
    id: 'AUTH-03',
    role: 'authority',
  ...
  },
  {
    ...
    owner: 'JASON',
    effort: '15 min',
    detail: 'Claim 5 VERIFIED COMPLETE 2026-08-03 ~04:09 CT — parent browser Jason Holloway zh5779485@gmail.com. business.google.com/locations Verified (1); Seventh City Press · Kansas City, MO, USA; public profile + Search KP live; website seventhcitypress.com. NO CSV re-import needed. NO paid verify / no ads. Residual hygiene (non-blocking): Complete Info + photos/phone/hours/posts draft-only until Jason approves.',
    dueContext: 'AUTH-04 CLOSED · bonus beyond week bar 3/3 · KP live for imprint.',
  },
  {
    id: 'AUTH-05',
    role: 'authority',
  ...
  },
  {
    ...
    owner: 'JASON',
    effort: '20 min',
    detail: 'Claim 3 VERIFIED COMPLETE 2026-08-03 ~02:57 CT — books.google.com/partner redirects to Play Books Partner Center (merged). Logged in Jason Holloway zh5779485@gmail.com /a/18360388366044352902. Catalog 4/4 Live: 9798256008819 / 9798256009625 / 9798256009809 / 9798295778926. Publisher Seventh City Press; Country US; phone present. Packet CLOSED.',
    dueContext: 'CLOSED · week bar 3/3 with Claim 1 + Claim 4.',
  },
  {
    id: 'AUTH-07',
    role: 'authority',
...
export const platforms: PlatformNode[] = [
  ...
  { id: 'is',   name: 'IngramSpark',            type: 'Print + EPUB + Direct',    status: 'live',    note: 'All Masters X print titles LIVE/APPROVED ~2026-08-03 CT (Jason); PUB-11 wholesale verify still open',  role: 'publishing' },
  ...
  { id: 'gsc2', name: 'GSC (Imprint)',           type: 'seventhcitypress.com',    status: 'live',    note: 'Claim 4 COMPLETE ~03:54 CT — AUTH-01 CLOSED · sc-domain:seventhcitypress.com · sitemap Success · discovered pages=3 hygiene', role: 'authority' },
  ...
  { id: 'gbp',  name: 'Google Business Profile', type: 'Verified · KC MO',        status: 'live',    note: 'Claim 5 COMPLETE ~04:09 CT — AUTH-04 CLOSED · Verified (1) · KP live · hygiene: photos/phone/hours draft-only', role: 'authority' },
  ...
  { id: 'gbk',  name: 'Google Books Partner',    type: '4/4 Live (Partner Center)', status: 'live',  note: 'Claim 3 COMPLETE — AUTH-06 CLOSED · /a/18360388366044352902', role: 'authority' },
  ...
  { id: 'ig',   name: 'Instagram',               type: '@jasonhollowaykc',        status: 'live',    url: 'https://www.instagram.com/jasonhollowaykc/', role: 'marketing' },
  { id: 'fb',   name: 'Facebook Author Page',    type: 'Jason Carroll Holloway',  status: 'live',    url: 'https://www.facebook.com/profile.php?id=61588710027163', role: 'marketing' },
  { id: 'tw',   name: 'X (Twitter)',             type: '@jasonhollowaykc',        status: 'live',    url: 'https://x.com/jasonhollowaykc', role: 'marketing' },
  { id: 'pin',  name: 'Pinterest',               type: 'seventhcitypress',        status: 'live',    url: 'https://www.pinterest.com/seventhcitypress/', note: 'API Trial — 49 pins queued', role: 'marketing' },
...
export const teamBriefs: TeamBrief[] = [
  ...
  },
  {
    ...
    grade: 'B-',
    gradeColor: '#f59e0b',
    summary: 'All four social platforms are now live and cross-linked: Instagram, Facebook Author Page, X (@jasonhollowaykc), and Pinterest. Website footers, JSON-LD sameAs, and rel=me tags are wired. Pinterest pins queued but blocked by API Trial access. Email capture still missing.',
    strengths: [
      'Instagram @jasonhollowaykc — live',
      'Facebook Author Page — live (privacy-separated from personal profile)',
      'X @jasonhollowaykc — live with author headshot + SCP header',
      'Pinterest seventhcitypress — live',
      'All 4 accounts cross-linked in website footers, About, Contact, JSON-LD',
      'rel=me link tags on both sites for profile verification',
    ...
    gaps: [
      'Pinterest: 49 pins queued but blocked by API Trial access (need Standard access)',
      'Facebook: custom username not yet set (using numeric ID URL)',
    ...
    topRecommendation: 'Set a custom Facebook Page username (Settings → General → Username) to replace the numeric URL. Then claim StoryGraph and wire the email opt-in form — every visitor without a capture is a lost reader.',
  },
  {
    role: 'authority',
    ...
    grade: 'C+',
    gradeColor: '#ef4444',
    summary: 'Structured data on the site is excellent (JSON-LD, ISNI, sameAs). Google Books Partner CLOSED (Claim 3). GSC imprint CLOSED (Claim 4). GBP Claim 5 COMPLETE (AUTH-04) — Verified + Search KP live. Remaining gaps: Wikidata P856/P213, Open Library polish, GSC discovered-pages hygiene. Week Top-5 bar 3/3 CLOSED; Top-5 free claims done except Apple SIDELINED.',
    strengths: [
      'JSON-LD structured data solid on all book pages',
      'ISNI assigned + on site JSON-LD + llms.txt',
      'Google Books Partner / Play Partner Center live (4/4 EPUB catalog)',
      'Goodreads author 20924993 claimed',
      'GSC active on author domain with sitemap',
      'GSC imprint domain verified (sc-domain:seventhcitypress.com) + sitemap Success',
      'Google Business Profile Verified (1) · Seventh City Press KC MO · Search KP live',
      'Bing Webmaster + Brave submitted',
      'Wikidata entity Q140275300 exists',
    ],
    gaps: [
      'Wikidata missing P856 (official website) + P213 (ISNI)',
      'GSC imprint discovered pages=3 only (sitemap/index hygiene)',
      'GBP Profile Strength / photos / phone / hours / posts — draft-only until Jason approves',
      'Open Library works polish optional',
      'VIAF pending / LoC PCN not started',
    ],
    topRecommendation: 'Next: approve guerrilla plan · draft review-ask · GSC 3-page hygiene. GBP polish (photos/phone/hours/posts) draft-only — no Google Ads. Wikidata P856 + P213 when free.',
  },
  {
    role: 'creative',
