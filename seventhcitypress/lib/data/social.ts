/**
 * Social media profile URLs for Seventh City Press.
 * Update these when accounts are confirmed live.
 * Keep in sync with /lib/data/authorAuthority.ts in the root project.
 */
