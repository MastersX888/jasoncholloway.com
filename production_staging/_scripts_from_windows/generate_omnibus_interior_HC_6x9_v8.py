...
DOCX_PATH1 = Path(r"C:\Users\zh577\.gemini\antigravity\scratch\jasoncholloway\files_3_extracted\MASTERS_X_BOOK1_ITALICIZED_FIXED.docx")
DOCX_PATH2 = Path(r"C:\Users\zh577\.gemini\antigravity\scratch\jasoncholloway\files_3_extracted\MASTERS_X_BOOK2_ITALICIZED_FIXED.docx")
DOCX_PATH3 = Path(r"C:\Users\zh577\.gemini\antigravity\scratch\jasoncholloway\files_3_extracted\MASTERS_X_BOOK3_ITALICIZED_FIXED.docx")
OUTPUT_DIR = Path(r"C:\Users\zh577\.gemini\antigravity\scratch\jasoncholloway\Jason_Carroll_Holloway_Final_Export") #  / "Omnibus_BW_Hardcover"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
# Write new build to a versioned filename so the original (stale) PDF stays
# untouched until the rebuild is verified.
OUTPUT_PDF = Path(BUILD_OUTPUT) if BUILD_OUTPUT else (OUTPUT_DIR / "INTERIOR_MASTERS_X_OMNIBUS_HC_6x9_v8.pdf")

# ─── Trim (IngramSpark Royal Demy 6.14 x 9.21) ───
TRIM_W = 6.14 * inch
TRIM_H = 9.21 * inch
M_GUTTER  = 1.0 * inch      # generous gutter for case-bound ~536pp
M_OUTSIDE = 0.85 * inch     # outside margin
M_TOP     = 0.9 * inch
M_BOTTOM  = 1.0 * inch
TEXT_W = TRIM_W - M_GUTTER - M_OUTSIDE   # 4.29"
TEXT_H = TRIM_H - M_TOP - M_BOTTOM       # 7.31"
