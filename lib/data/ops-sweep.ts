...
export const tasks: SweepTask[] = [
  ...
  // ── AUTHORITY & DISCOVERY ──────────────────────────────────────
  {
    ...
    owner: 'JASON',
    effort: '10 min',
    detail: 'GSC > Add property > HTML tag method. Token wired via GOOGLE_SITE_VERIFICATION_SCP GitHub secret → redeploy → Verify → submit sitemap.xml.',
  },
  {
    id: 'AUTH-02',
    role: 'authority',
...
export const platforms: PlatformNode[] = [
  ...
  { id: 'gbp',  name: 'Google Business Profile', type: 'CSV import ready',        status: 'open',    note: 'CSV + logo URL ready — import at business.google.com', role: 'authority' },
