/**
 * Canonical social profile URLs — footers, About, Contact, JSON-LD sameAs.
 * Keep seventhcitypress/lib/socialProfiles.ts in sync.
 */
...
/** Imprint account. Author @jasonhollowaykc.bsky.social was suspended 2026-07-31. */
