...
**Upload ready:** YES (rebuilt 2026-08-29, twice: centering fix + canon fix)
**Carries:** scene-break centering fix AND the Chapter One canon fix — one upload covers both
...
## Present
- `9798256008819.epub` — 754,069 bytes, rebuilt 2026-08-29 from the geo-fixed BUILD docx
