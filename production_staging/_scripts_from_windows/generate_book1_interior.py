...
OUTPUT_DIR = Path(r"C:\Users\zh577\.gemini\antigravity\scratch\jasoncholloway\Jason_Carroll_Holloway_Final_Export") #  / "Standard_BW_Hardcover" / "Book1_The_Inheritance_of_Frequency"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_PDF = Path(BUILD_OUTPUT) if BUILD_OUTPUT else (OUTPUT_DIR / "INTERIOR_MASTERS_X_BOOK1.pdf")

# Standard B&W hardcover Bowker ISBN for Volume One.
BOOK_ISBN = (
    os.environ.get("MASTERSX_STANDARD_HC_BOOK1_ISBN", "").strip()
    or "979-8-2958-0080-1"
)
