...
OUTPUT_DIR = Path(r"C:\Users\zh577\.gemini\antigravity\scratch\jasoncholloway\Jason_Carroll_Holloway_Final_Export") #  / "Standard_BW_Hardcover" / "Book2_The_Grimoire"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_PDF = Path(BUILD_OUTPUT) if BUILD_OUTPUT else (OUTPUT_DIR / "INTERIOR_MASTERS_X_BOOK2.pdf")

# Standard B&W hardcover Bowker ISBN for Volume Two (6x9).
BOOK_ISBN = (
    os.environ.get("MASTERSX_STANDARD_HC_BOOK2_ISBN", "").strip()
    or "979-8-2958-1267-5"
)

# --- Trim ---
TRIM_W = (BUILD_WIDTH_PT / 72.0 * inch) if BUILD_WIDTH_PT else (6.14 * inch)
TRIM_H = (BUILD_HEIGHT_PT / 72.0 * inch) if BUILD_HEIGHT_PT else (9.21 * inch)
M_GUTTER = 0.70 * inch
