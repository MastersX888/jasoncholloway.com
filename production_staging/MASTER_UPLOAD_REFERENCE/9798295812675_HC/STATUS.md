...
> `production_staging/b2_grimoire/9798295812675_HC/STATUS.md`.
>
> **Live / authoritative page count: 225 pp**, which the current rebuild matches exactly.
> The `Upload ready: NO — spine recheck required before Ingram` line and the
> `~225 pp (NEAR_LIVE vs CANON 218)` figure below are stale — 225 is not near-live, it is
> live. The "+7 HC / +11 PB drift" reported earlier on 2026-08-29 was a comparison against
> stale pre-geo-fix canon numbers, not a regression, and was retracted the same day; no
...
## Present
- `interior.pdf` — post-geo rebuild · Royal 6.14×9.21 · ~225 pp (NEAR_LIVE vs CANON 218)
- `cover_jacket.pdf` — **geometry era** (`JACKET_MX2_9798295812675_v1.pdf`) · matches site `book2-hardcover-v3.png`
- `cover_caselam.pdf` — geometry era (`CASE_MX2_9798295812675_v1.pdf`)
