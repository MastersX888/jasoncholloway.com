...
**Status:** **Superseded for production architecture** — see **`02_PUBLICATION_ARCHITECTURE_REV3.md`** (July 10, 2026 author pivot).

> **Rev. 3 (authoritative):** **8.5×11 in** trim · **Option B:** Companion + Dictionary box set · **Print:** BookVault Bespoke primary (Fable); Ingram optional trade Companion only · `sources/frequency_data/` in repo.  
> See `02_PUBLICATION_ARCHITECTURE_REV3.md` and `03_TWO_PRODUCT_TOC.md`.

---

## 1. Executive Summary *(Rev. 1–2 — historical)*
...
*Rev. 3 replaces this single-volume model with dictionary-centered multi-volume print.*
