...
"""
Masters X Book 3 Interior PDF Generator v5 (6x9 hardcover)
...
OUTPUT_DIR = Path(r"C:\Users\zh577\.gemini\antigravity\scratch\jasoncholloway\Jason_Carroll_Holloway_Final_Export") #  / "Standard_BW_Hardcover" / "Book3_The_Kingdom"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
OUTPUT_PDF = Path(BUILD_OUTPUT) if BUILD_OUTPUT else (OUTPUT_DIR / "INTERIOR_MASTERS_X_BOOK3_PB_6x9.pdf")

# Standard B&W hardcover Bowker ISBN for Volume Three (6x9).
BOOK_ISBN = (
    os.environ.get("MASTERSX_STANDARD_HC_BOOK3_6X9_ISBN", "").strip()
    or "979-8-2958-1270-5"
)
