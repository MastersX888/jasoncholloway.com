...
// Synced from IngramSpark report.csv via scripts/sync-ingram-metadata.py
...
export const catalog: CatalogBook[] = [
  ...
  },
  {
    ...
    editions: [
      { format: "Paperback", isbn: "9798256072704", price: "$19.99", pageCount: 734, specifications: "Collected Paperback · 5.5×8.5 in · 734 pages" },
      { format: "Hardcover", isbn: "9798295884412", price: "$29.99", pageCount: 686, specifications: "Jacketed Case Laminate · 6.14×9.21 in · 686 pages" },
    ],
  },
  {
    id: "hawkes-monograph",
    ...
    excerpt: "The grape appears 129 times across 16 novels. It is the most frequent non-human image in the Hawkes canon. This is not accident. This is architecture.",
    keywords: ["American literature", "grape motif", "John Hawkes", "literary criticism", "postmodern fiction", "symbolism", "The Blood Oranges"],
    editions: [
      { format: "Paperback", isbn: "9798295778247", price: "$14.98", pageCount: 84, specifications: "Trade Paperback · 6×9 in" },
