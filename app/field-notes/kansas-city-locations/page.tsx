...
const faqs = [
  {
    ...
    a: "The trilogy is set primarily in Quality Hill, Westport, the West Bottoms (Genessee Street area), and downtown Kansas City (Hotel Phillips area). Miller Nichols Library at UMKC is the opening setting.",
  },
  {
    q: "Can I visit the locations in Masters X?",
    a: "Yes — all the Kansas City locations in the trilogy are real and accessible. Miller Nichols Library is open to UMKC students and the public for research. Quality Hill, Westport, and the West Bottoms are walkable neighborhoods. The KC Streetcar runs along Main Street.",
  },
  {
    ...
    <FieldNoteLayout
      ...
      record={
        <>
          ...
          <p className="fn-body">
            The specific locations in the trilogy include: <strong>Miller Nichols Library</strong> at the University of Missouri–Kansas City (UMKC) — a real campus library, the primary research library for the university on Volker Boulevard. <strong>Quality Hill</strong> — a historically significant neighborhood on the western edge of downtown Kansas City, developed in the late nineteenth century as the city's first elite residential district. <strong>The West Bottoms</strong> — the low-lying industrial district west of downtown, below the bluffs, historically a stockyards and meatpacking area, now a mix of antique markets, event spaces, and artists' studios.
          </p>
          <p className="fn-body">
      ...
      pattern={
        <>
          <p className="fn-body">
            Kansas City is an underused setting in American literary fiction — despite its significant history, its unusual geography (built on river bluffs above a wide floodplain), its role in jazz history, and the striking contrast between its dense historic neighborhoods and its underground limestone infrastructure. The city rewards close attention: the bluffs above the West Bottoms, the view from Quality Hill toward the river, the strange persistence of the stockyards grid in streets now occupied by antique dealers and wedding venues.
          </p>
          <p className="fn-body">
            SubTropolis, visible only as an unmarked hill from Cemetery Road NE, is one of the great invisible urban landmarks in America. The city has layers — geological, historical, architectural — that most of its own residents have never fully registered. The Masters X Trilogy is partly an argument that Kansas City is stranger and more significant than American fiction has so far noticed.
          </p>
        </>
      }
      fiction={
        <>
          <p className="fn-body">
            Blake Masters' Kansas City is the city as it physically exists, rendered as precisely as the author can manage. The corner table at Miller Nichols Library is in the right part of the building, near the right radiator. The walk from Quality Hill down to the West Bottoms follows the actual grade of the bluffs. The Hotel Phillips has the lobby the novel describes.
          </p>
          <p className="fn-body">
