...
| **The Resonant Frequency Dictionary** | TBD (set + 3 vols.) | Full A–Z dictionary only — **no** encyclopedia essays mixed in | **2,062 pp** measured (Fable Pass 2) → **3-vol. box set** |
...
| **Core — 115k headwords** | **Dictionary box set** | **2,062 pp** (Fable Pass 2: 3 vols.) |
...
|--------|-----------------|
| **Fable Pass 2 (production typography)** | **2,062** — 3 vols: 546 / 714 / 802 @ 56.8 e/page |
| Cursor sample (superseded) | ~3,156 @ 36.6 e/page — stale letter parse |
...
**Dictionary volume split (Fable Pass 2 — author sign-off pending):** **3 volumes** — Vol. 1 A–D (546 pp) · Vol. 2 E–M (714 pp) · Vol. 3 N–Z + back matter (802 pp). See `output/print/DICTIONARY_VOLUME_PLAN.md`. Supersedes Cursor 4/8-vol projections.
