    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: "New Press Inquiry — SeventhCityPress.com",
          from_name: "Seventh City Press Website",
        }),
      });
    ...
    <form onSubmit={handleSubmit} className="card" style={{ background: "var(--bg-raised)", borderColor: "var(--border)", padding: "2rem" }} noValidate>
      <div style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ fontSize: "0.9rem", color: "var(--text-muted)", lineHeight: 1.6 }}>
          Use the form below to send a direct message to the Seventh City Press communications desk.
        </p>
      </div>
