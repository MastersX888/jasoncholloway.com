...
export interface Book {
  ...
  pageCountHC?: number;
  /**
   * Publication dates as filed with IngramSpark (see ingram-catalog.json). Formats
   * released on different dates, so schema.org `datePublished` is tracked per
   * edition; `datePublished` is the earliest of them and describes the work.
   */
  datePublished: string;
  datePublishedHC?: string;
  datePublishedPB?: string;
  datePublishedEbook?: string;
  description: string;
  shortDesc: string;
  excerpt: string;
  keywords: string[];
...
const bookSeeds: BookSeed[] = [
  {
    ...
    coverImage: "/covers/book1-paperback-web.jpg",
    coverImageHC: "/covers/book1-hardcover-v3.png",
    coverImageCase: "/covers/book1-hc-case.png",
    coverImagePB: "/covers/book1-paperback-web.jpg",
  ...
  },
  {
    ...
    coverImage: "/covers/book2-paperback-web.jpg",
    coverImageHC: "/covers/book2-hardcover-v3.png",
    coverImageCase: "/covers/book2-hc-case.png",
    coverImagePB: "/covers/book2-paperback-web.jpg",
  ...
  },
  {
    ...
    coverImage: "/covers/book3-paperback-web.jpg",
    coverImageHC: "/covers/book3-hardcover-v3.png",
    coverImageCase: "/covers/book3-hc-case.png",
    coverImagePB: "/covers/book3-paperback-web.jpg",
  ...
  },
  {
    ...
    buyLinks: [
      ...
      { label: "Bookshop.org (Independent)", url: bookshopIsbnUrl("9798256072704"), format: "Paperback" },
      { label: "Bookshop.org (Independent)", url: bookshopIsbnUrl("9798295884412"), format: "Hardcover" },
    ],
  },
  {
    ...
    buyLinks: [
      ...
      { label: "Bookshop.org (Independent)", url: bookshopIsbnUrl("9798349308444"), format: "Hardcover" },
    ],
  }
];
